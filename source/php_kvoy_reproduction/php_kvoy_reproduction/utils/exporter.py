...
from php_kvoy_reproduction.tasks.tracking.mdp import MotionCommand
...
def attach_onnx_metadata(env: ManagerBasedRLEnv, run_path: str, path: str, filename="policy.onnx") -> None:
    ...
    motion_command: MotionCommand = env.command_manager.get_term("motion")
    ...
    metadata = {
        ...
        "motion_files": [Path(motion_file).name for motion_file in motion_command.motion.motion_files],
        "motion_signatures": list(motion_command.motion.motion_signatures),
        "motion_start_indices": ",".join(
            str(int(value)) for value in motion_command.motion.motion_start_idx.cpu().tolist()
        ),
        "motion_end_indices": ",".join(
            str(int(value)) for value in motion_command.motion.motion_end_idx.cpu().tolist()
        ),
    }
